...
Two tree-based models, rpart and random forest, will be built and their performances compared.

### rpart Model
As the outcomes are categorical (nominal), a decision tree was built using the method rpart.
```{r}
